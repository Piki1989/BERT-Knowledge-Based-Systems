...
MODEL_NAME = "psmeros/SciNewsBERT"
DATA_PATH =  "./data/protective_papers_dataset_78000_clean.json"
#"../data/Output.json"

split_idx_file = "./split_idx_78000_gpu1.csv"
...
MLM_DIR = "./model_dapt_TH_78000kt_scinewsbert"
SBERT_DIR = "./model_sbert_TH_78000k_scinewsbert"
...
for epoch in tqdm(range(MLM_EPOCHS)):
...
for epoch in range(num_epochs):
    ...
    for batch in loop:
        ...
        if (step + 1) % 10 == 0:  
            ...
            with open("bert_train_res_gpu2.txt", "a") as myfile:
